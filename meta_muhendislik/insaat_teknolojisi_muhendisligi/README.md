# Insaat Teknolojisi Muhendisligi

Bu klasör **Insaat Teknolojisi Muhendisligi** alanına ait akademik notlar, araştırmalar, lisansüstü çalışmalar ve sektörel standartlar içindir.
