# Su Urunleri Isletme Teknolojisi

Bu klasör **Su Urunleri Isletme Teknolojisi** alanına ait akademik notlar, araştırmalar, lisansüstü çalışmalar ve sektörel standartlar içindir.
