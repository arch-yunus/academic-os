# Bilgisayar Destekli Tasarim Ve Animasyon

Bu klasör **Bilgisayar Destekli Tasarim Ve Animasyon** alanına ait akademik notlar, araştırmalar, lisansüstü çalışmalar ve sektörel standartlar içindir.
