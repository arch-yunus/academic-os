# Erasmus Ve Global Degisim Programlari

Bu klasör **Erasmus Ve Global Degisim Programlari** alanına ait akademik notlar, araştırmalar, lisansüstü çalışmalar ve sektörel standartlar içindir.
