# Tekstil Teknolojisi Muhendisligi

Bu klasör **Tekstil Teknolojisi Muhendisligi** alanına ait akademik notlar, araştırmalar, lisansüstü çalışmalar ve sektörel standartlar içindir.
