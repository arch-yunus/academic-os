# Hizli Ogrenme Teknikleri

Bu klasör **Hizli Ogrenme Teknikleri** alanına ait akademik notlar, araştırmalar, lisansüstü çalışmalar ve sektörel standartlar içindir.
